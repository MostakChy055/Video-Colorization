...
Original file is located at
    https://colab.research.google.com/drive/1engWwOj7NjfwBYKaB20pvhvFxVBKBNVC
"""
...
class MultiStepLR_Restart(_LRScheduler):
    ...
    def get_lr(self):
        # Is responsible for calculating the learning rate for each parameter group in the optimizer at a given epoch.
...
class CosineAnnealingLR_Restart(_LRScheduler):
    ...
    def get_lr(self):
        if self.last_epoch == 0:
            ...
            # Checks if the current epoch is at the end of a cosine annealing cycle (halfway through the period).
            return [
                group["lr"]
